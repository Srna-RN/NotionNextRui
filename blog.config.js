 ...
 * @LastEditTime: 2026-04-27 19:27:09
 * @FilePath: /NotionNextRui/blog.config.js
 */
...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'heo', // 当前主题，在 themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'RUIRUI', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一名分享干货的程序员👨🏻‍💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://skrlx.ccwu.cc/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'RUIRUI, 博客', // 网站关键词 英文逗号隔开
